...
class MCPTestHelper:
    ...
    @staticmethod
    def validate_tool_response(response: Dict[str, Any], expected_content_type: str = 'text') -> bool:
    ...
    def validate_aws_response_structure(data: Any, service: str) -> bool:
        ...
        service_validators = {
            'ec2': lambda d: 'Reservations' in d or 'SecurityGroups' in d or 'Vpcs' in d,
    ...
    @staticmethod
    async def test_tool_with_args(client, tool_name: str, args: Dict[str, Any]) -> Dict[str, Any]:
            ...
            for resource in resources:
                try:
                    ...
                    if 'contents' in resource_response:
                        ...
                        results['failed_tests'] += 1
                        results['errors'].append(f"Invalid resource response for {resource['uri']}")
                except Exception as e:
                    results['failed_tests'] += 1
                    results['errors'].append(f"Error reading resource {resource['uri']}: {str(e)}")
