...
class TestS3Service:
    ...
    async def test_list_objects_v2_with_max_keys(self, mcp_server):
        ...
        result = await s3_list_objects_v2(
            profile_name="test", region="us-east-1", bucket_name=bucket_name, max_keys=2
        )
    ...
    async def test_list_objects_v2_with_delimiter(self, mcp_server):
        ...
        s3_client.put_object(
            Bucket=bucket_name, Key="folder1/file1.txt", Body="content1"
        )
        s3_client.put_object(
            Bucket=bucket_name, Key="folder1/file2.txt", Body="content2"
        )
        s3_client.put_object(
            Bucket=bucket_name, Key="folder2/file3.txt", Body="content3"
        )
    ...
    async def test_list_objects_v2_empty_bucket(self, mcp_server):
        ...
        result = await s3_list_objects_v2(
            profile_name="test", region="us-east-1", bucket_name=empty_bucket
        )
