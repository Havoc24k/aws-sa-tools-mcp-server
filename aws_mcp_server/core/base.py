...
class AWSService(ABC):
    ...
    def _format_filters(self, filters: Optional[Dict[str, Any]]) -> Optional[list]:
...
class PaginatedAWSService(AWSService):
    ...
    def _paginate_results(self, operation_name: str, params: Dict[str, Any], 
                         max_results_key: str = 'MaxResults',
                         next_token_key: str = 'NextToken') -> Dict[str, Any]:
